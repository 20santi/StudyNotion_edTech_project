...
export default function Setting() {
  ...
  return (
    <div className="w-screen">
      <div className="text-white flex flex-col items-center justify-center gap-y-5 w-11/12 max-w-maxContent mx-auto mt-10">
        <div className="flefx flex-col items-start">
          {/* back button */}
          <div>
          ...
          <div className="flex w-[792px] mt-5 bg-richblack-800 border-richblack-700 rounded-lg h-[126px] p-6">
