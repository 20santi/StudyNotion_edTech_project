      ...
      <div className="flex flex-col gap-y-5 w-[555px]">
        ...
        <div className="flex gap-x-6 mt-16">
          <IconButton
            text={btn1}
            customClass={
              "text-[16px] leading-6 font-inter font-semibold text-richblack-900 rounded-lg bg-yellow-50 w-[179px] h-[48px] shadow-[2px_2px_0px_0px_rgba(255,255,255,0.51)]"
            }
          />
          <IconButton
            text={btn2}
            customClass={
              "text-[16px] leading-6 font-inter font-semibold text-richblack-200 rounded-lg bg-richblack-800 w-[135px] h-[48px] shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)]"
            }
          />
        </div>
      </div>
