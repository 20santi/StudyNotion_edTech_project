  ...
  return (
    <div className="">
      ...
      <div className="flex flex-col pt-28 items-center">
        <div className="flex flex-col items-center gap-y-9">
          <Link to={"/login"}>
            <IconButton
              ...
              customClass={
                "text-[16px] leading-6 font-inter font-semibold text-richblack-200 rounded-lg bg-richblack-800 w-[235px] h-[44px] shadow-[0px_1px_0px_0px_rgba(255,255,255,0.18)]"
              }
            />
          </Link>
          ...
          <div className="flex gap-x-6">
            <IconButton
              text={"Learn More"}
              customClass={
                "text-[16px] leading-6 font-inter font-semibold text-richblack-900 rounded-lg bg-yellow-50 w-[135px] h-[48px] shadow-[2px_2px_0px_0px_rgba(255,255,255,0.51)]"
              }
            />
            <IconButton
              text={"Book a Demo"}
              customClass={
                "text-[16px] leading-6 font-inter font-semibold text-richblack-200 rounded-lg bg-richblack-800 w-[149px] h-[48px] shadow-[2px_2px_0px_0px_rgba(255,255,255,0.18)]"
              }
            />
          </div>
        </div>
        ...
        <div className="mt-20">
          <img src={image1} width="1035px" height="535px" />
        </div>
